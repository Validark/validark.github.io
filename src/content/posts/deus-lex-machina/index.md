...
The new [compacting tokenizer](https://github.com/Validark/Accelerated-Zig-Parser/blob/7fa80343eb177c0220276492d467cdf6d3dabb73/src/main.zig#L1912) processes an entire 64-byte chunk of source code at once (soon to be 512!). It includes:
  ...
  - [SIMD hasher of up to 16 multi-char symbols at once](https://github.com/Validark/Accelerated-Zig-Parser/blob/7fa80343eb177c0220276492d467cdf6d3dabb73/src/main.zig#L1518), which works across chunk boundaries to produce the proper `kind` of mult-char symbols.
